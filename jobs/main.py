...
def generate_gps_data(device_id, timpestamp, vehicle_type='private'):
    return {
        'id': uuid.uuid4(),
        'deivceId': device_id,
...
def generate_traffic_camera_data(device_id, timestamp, location, camerate_id):
    return {
        'id': uuid.uuid4(),
        'deviceId': device_id,
        'cameratId': camerate_id,
        'location': location,
        'timestamp': timestamp,
...
def generate_emergency_incident_data(device_id, timestamp, location):
    return {
        ...
        'type': random.choice(['Accident', 'Fire', 'Mdecial', 'Police', 'None']),
        'location': location,
        'timestamp': timestamp,
...
def simulate_journey(producer, device_id):
    while True:
        ...
        trafic_camera_data = generate_traffic_camera_data(device_id, vehicle_data['timestamp'], vehicle_data['location'],'Nikon-Cam123')
        ...
        produce_data_to_kafka(producer, TRAFFIC_TOPIC, trafic_camera_data)
...
if __name__ == "__main__":
    ...
    try:
        simulate_journey(producer, 'Vehicle-ChauMinhTruong')
